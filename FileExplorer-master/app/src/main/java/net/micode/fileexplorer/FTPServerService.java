...
public class FTPServerService extends Service implements Runnable {
    ...
    private void setupNotification() {
        ...
        Notification notification=setLatestEventInf(icon,tickerText,when,getApplicationContext(), contentTitle, contentText, contentIntent);
    ...
    public Notification setLatestEventInf(int icon,CharSequence ticker,long when,Context context,CharSequence charSequence,CharSequence charSequence2,PendingIntent intent){
