  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   304: ldc 192
    //   306: lconst_0
    //   307: invokeinterface 195 4 0
    //   312: lconst_0
    //   313: lcmp
    //   314: ifne +33 -> 347
    //   317: invokestatic 175	com/ads/Validation:h	()Landroid/content/SharedPreferences$Editor;
    //   320: ldc 192
    //   322: new 197	java/util/Date
    //   325: dup
    //   326: invokespecial 198	java/util/Date:<init>	()V
    //   329: invokevirtual 202	java/util/Date:getTime	()J
    //   332: invokeinterface 206 4 0
    //   337: pop
    //   338: invokestatic 175	com/ads/Validation:h	()Landroid/content/SharedPreferences$Editor;
    //   341: invokeinterface 209 1 0
    //   346: pop
    //   347: new 197	java/util/Date
    //   350: dup
    //   351: invokespecial 198	java/util/Date:<init>	()V
    //   354: invokevirtual 202	java/util/Date:getTime	()J
    //   357: invokestatic 46	com/ads/Validation:b	()Landroid/content/SharedPreferences;
    //   360: ldc 192
    //   362: lconst_0
    //   363: invokeinterface 195 4 0
    //   368: lsub
    //   369: ldc2_w 210
    //   372: ldiv
    //   373: lstore 4
    ...
    //   401: checkcast 213	android/app/Activity
    //   404: new 215	com/ads/Validation$1$1
    //   407: dup
    //   408: aload_0
    //   409: invokespecial 218	com/ads/Validation$1$1:<init>	(Lcom/ads/Validation$1;)V
    //   412: invokevirtual 222	android/app/Activity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   415: return
    //   416: aload 7
    //   418: aload 8
    ...
    //   432: astore 6
    //   434: aload 6
    //   436: invokevirtual 225	java/lang/Exception:printStackTrace	()V
    //   439: return
