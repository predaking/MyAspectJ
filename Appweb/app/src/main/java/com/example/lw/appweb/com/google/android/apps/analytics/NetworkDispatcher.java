    ...
    extends HandlerThread
  {
      ...
      implements Runnable
    {
        ...
        throws IOException, ParseException, HttpException
      {
        ...
        int i = 0;
        if ((i < this.hits.size()) && (i < DispatcherThread.this.maxEventsPerRequest))
        {
          ...
          for (;;)
          {
            ...
            ((HttpEntityEnclosingRequest)localObject2).addHeader("User-Agent", DispatcherThread.this.userAgent);
          ...
          for (;;)
          {
            ...
            if (paramBoolean) {
              ...
              DispatcherThread.this.pipelinedRequester.addRequest((HttpEntityEnclosingRequest)localObject2);
            }
          }
        }
        if (!paramBoolean) {
      ...
      public void run()
      {
        ...
        //   27	74	2	l1	long
        //   67	31	4	l2	long
        //   143	8	6	localInterruptedException	java.lang.InterruptedException
      ...
      implements PipelinedRequester.Callbacks
    {
      ...
      public void pipelineModeChanged(boolean paramBoolean)
      {
        if (paramBoolean)
        {
          DispatcherThread.access$1002(DispatcherThread.this, 30);
          return;
        }
        DispatcherThread.access$1002(DispatcherThread.this, 1);
      }
      ...
      public void requestSent()
      {
        ...
        {
          return;
          localHit = DispatcherThread.this.currentTask.removeNextHit();
        } while (localHit == null);
        DispatcherThread.this.callbacks.hitDispatched(localHit.hitId);
      }
      
      public void serverError(int paramInt)
      {
        DispatcherThread.access$502(DispatcherThread.this, paramInt);
      }
    }
  }
}
