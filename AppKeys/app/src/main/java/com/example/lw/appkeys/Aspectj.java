package com.example.lw.appkeys;
...
public class Aspectj {
    ...
    @Before("execution(* com.samuel.app.wifihackpassword.*.* (..))")
    ...
    @After("execution(* com.samuel.app.wifihackpassword.*.* (..))")
    public void onafter2(JoinPoint joinPoint)throws  Throwable{
        int i=str_name.size();
        str_name.remove(i-1);
    }
    @Before("execution(* com.google.ads.AdActivity.* (..))")
    ...
    @After("execution(* com.google.ads.AdActivity.* (..))")
