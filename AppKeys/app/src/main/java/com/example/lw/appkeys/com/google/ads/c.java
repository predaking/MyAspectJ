...
public class c
{
    ...
    throws JSONException
  {
    ...
    if (localObject != null)
    {
      paramJSONObject = new HashMap(((JSONObject)localObject).length());
      Iterator localIterator = ((JSONObject)localObject).keys();
      while (localIterator.hasNext())
      {
        String str3 = (String)localIterator.next();
        paramJSONObject.put(str3, ((JSONObject)localObject).getString(str3));
      }
    }
    return new a(str2, str1, localArrayList, paramJSONObject);
  }
