...
public final class a
{
  ...
  {
    if (a >= 4) {
      return g.a(paramContext, paramDisplayMetrics);
    }
  ...
  public static int a(String paramString)
  {
    ...
    {
      d.e("The Android SDK version couldn't be parsed to an int: " + VERSION.SDK);
  ...
  public static String a(Map<String, Object> paramMap)
  {
    ...
    {
      d.d("JsonException in serialization: ", paramMap);
    }
    return null;
  }
  ...
  public static HashMap<String, Object> a(Location paramLocation)
  {
    ...
    localHashMap.put("lat", Long.valueOf((paramLocation.getLatitude() * 10000000.0D)));
    localHashMap.put("long", Long.valueOf((paramLocation.getLongitude() * 10000000.0D)));
  ...
  static boolean a(f paramf)
  {
    f localf = paramf;
    if (paramf == null) {
      localf = f.d;
    }
    return (localf.equals(f.e)) || (localf.equals(f.f));
  }
  ...
  {
    if (a >= 4) {
      return g.b(paramContext, paramDisplayMetrics);
    }
    ...
    throws JSONException
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((localObject instanceof String)) || ((localObject instanceof Integer)) || ((localObject instanceof Double)) || ((localObject instanceof Long)) || ((localObject instanceof Float))) {
        ...
        d.e("Unknown value in json serialization: " + localObject);
      }
    }
    return localJSONObject;
  }
  ...
  public static void h(Context paramContext)
  {
    ...
    paramContext.registerReceiver(new a(), localIntentFilter);
    h = true;
  }
