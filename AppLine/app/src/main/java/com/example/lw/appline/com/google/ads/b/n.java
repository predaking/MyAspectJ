...
public class n
{
  ...
  public static ViewGroup a(Activity paramActivity, g paramg)
  {
    try
    {
      ...
      localGestureOverlayView.addOnGesturePerformedListener(new a(paramActivity, paramg, localGestureStore));
      return localGestureOverlayView;
    }
    catch (IOException paramActivity)
    {
      d.a("Gestures disabled: Error loading gesture data.", paramActivity);
    }
    return null;
  }
    ...
    implements OnGesturePerformedListener
  {
    ...
    public a(Activity paramActivity, g paramg, GestureStore paramGestureStore)
    {
    ...
    public void onGesturePerformed(final GestureOverlayView paramGestureOverlayView, Gesture paramGesture)
    {
      ...
      while (paramGesture.hasNext())
      {
        ...
        d.a("Gesture: '" + localPrediction.name + "' = " + localPrediction.score);
      }
      ...
      {
        new Builder(this.b).setMessage(paramGestureOverlayView).setTitle("Ad Information").setPositiveButton("Share", new OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            n.a.b(n.a.this).startActivity(Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", paramGestureOverlayView), "Share via"));
          }
        }).setNeutralButton("Report", new OnClickListener()
        {
          public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
          {
            new Thread(new m(n.a.a(n.a.this).d(), n.a.b(n.a.this).getApplicationContext())).start();
          }
