...
public final class x
{
  ...
  {
    paramArrayOfByte = a(paramArrayOfByte, paramInt1, paramInt2, paramArrayOfChar, 2147483647);
    ...
    throws w
  {
    ...
    if (m < paramInt2)
    {
      ...
      if ((i == i1) && (i2 < -5)) {
        throw new w("Bad Base64 input character at " + m + ": " + paramArrayOfChar[(m + paramInt1)] + "(decimal)");
      }
      if (i2 < -1) {
        break label382;
      }
    ...
    for (;;)
    {
      ...
      break;
      if (m < 2) {
        throw new w("Invalid padding char found in position " + m);
      }
      n = 1;
      i1 = (char)(paramArrayOfChar[(paramInt2 - 1 + paramInt1)] & 0x7F);
      if ((i1 != 61) && (i1 != 10)) {
        throw new w("encoded value has invalid trailing char");
      }
      continue;
      if (n != 0) {
        throw new w("Data found after trailing padding char at index " + m);
      }
      i1 = k + 1;
      arrayOfChar[k] = i;
      if (i1 == 4)
      {
        ...
        {
          if (k == 1) {
            throw new w("single trailing character at offset " + (paramInt2 - 1));
          }
          arrayOfChar[k] = '=';
