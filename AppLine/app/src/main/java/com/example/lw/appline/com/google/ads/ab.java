...
public final class ab
{
  ...
  private ab(OutputStream paramOutputStream, byte[] paramArrayOfByte)
  {
  ...
  public static ab a(OutputStream paramOutputStream)
  {
    return a(paramOutputStream, 4096);
  }
  
  public static ab a(OutputStream paramOutputStream, int paramInt)
  {
    return new ab(paramOutputStream, new byte[paramInt]);
  }
