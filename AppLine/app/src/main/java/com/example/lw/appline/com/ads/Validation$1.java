  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    //   264: ldc 185
    //   266: lconst_0
    //   267: invokeinterface 188 4 0
    //   272: lconst_0
    //   273: lcmp
    //   274: ifne +33 -> 307
    //   277: invokestatic 191	com/ads/Validation:f	()Landroid/content/SharedPreferences$Editor;
    //   280: ldc 185
    //   282: new 193	java/util/Date
    //   285: dup
    //   286: invokespecial 194	java/util/Date:<init>	()V
    //   289: invokevirtual 198	java/util/Date:getTime	()J
    //   292: invokeinterface 204 4 0
    //   297: pop
    //   298: invokestatic 191	com/ads/Validation:f	()Landroid/content/SharedPreferences$Editor;
    //   301: invokeinterface 208 1 0
    //   306: pop
    //   307: new 193	java/util/Date
    //   310: dup
    //   311: invokespecial 194	java/util/Date:<init>	()V
    //   314: invokevirtual 198	java/util/Date:getTime	()J
    //   317: invokestatic 160	com/ads/Validation:e	()Landroid/content/SharedPreferences;
    //   320: ldc 185
    //   322: lconst_0
    //   323: invokeinterface 188 4 0
    //   328: lsub
    //   329: ldc2_w 209
    //   332: ldiv
    //   333: lstore 4
    //   335: invokestatic 212	com/ads/Validation:g	()I
    //   338: i2l
    //   339: lload_2
    //   340: lcmp
    //   341: ifge +34 -> 375
    ...
    //   361: checkcast 214	android/app/Activity
    //   364: new 216	com/ads/Validation$1$1
    //   367: dup
    //   368: aload_0
    //   369: invokespecial 219	com/ads/Validation$1$1:<init>	(Lcom/ads/Validation$1;)V
    //   372: invokevirtual 223	android/app/Activity:runOnUiThread	(Ljava/lang/Runnable;)V
    //   375: return
    //   376: aload 7
    //   378: aload 8
    ...
    //   392: astore 6
    //   394: aload 6
    //   396: invokevirtual 226	java/lang/Exception:printStackTrace	()V
    //   399: return
